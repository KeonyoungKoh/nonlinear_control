...
extern const NeAssertData double_pendulum_2_836bb176_1_assertData[];
extern const NeZCData double_pendulum_2_836bb176_1_ZCData[];
void double_pendulum_2_836bb176_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void double_pendulum_2_836bb176_1_validateRuntimeParameters(
  const double *runtimeParameters,
  int32_T *assertSatisfactionFlags);
void double_pendulum_2_836bb176_1_computeAsmRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void double_pendulum_2_836bb176_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void double_pendulum_2_836bb176_1_initializeGeometries(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId double_pendulum_2_836bb176_1_compDerivs(
...
PmfMessageId double_pendulum_2_836bb176_1_numJacPerturbLoBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_numJacPerturbHiBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_compOutputsDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_compOutputsKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_compOutputs (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_computeZeroCrossings(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId double_pendulum_2_836bb176_1_recordLog(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
void double_pendulum_2_836bb176_1_setTargets(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  CTarget *targets);
void double_pendulum_2_836bb176_1_resetAsmStateVector(const void *mech, double
  *stateVector);
void double_pendulum_2_836bb176_1_resetSimStateVector(const void *mech, double
  *stateVector);
void double_pendulum_2_836bb176_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *modeVector,
  const double *motionData,
  double *stateVector);
void double_pendulum_2_836bb176_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void double_pendulum_2_836bb176_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void double_pendulum_2_836bb176_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void double_pendulum_2_836bb176_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void double_pendulum_2_836bb176_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void double_pendulum_2_836bb176_1_computePosDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void double_pendulum_2_836bb176_1_computeVelDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void double_pendulum_2_836bb176_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void double_pendulum_2_836bb176_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t double_pendulum_2_836bb176_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t double_pendulum_2_836bb176_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t double_pendulum_2_836bb176_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
boolean_T double_pendulum_2_836bb176_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
void double_pendulum_2_836bb176_1_convertStateVector(
  const void *asmMech,
...
void double_pendulum_2_836bb176_1_constructStateVector(
  const void *mech,
...
void double_pendulum_2_836bb176_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
boolean_T double_pendulum_2_836bb176_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
boolean_T double_pendulum_2_836bb176_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId double_pendulum_2_836bb176_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  double *stateVector,
  void *neDiagMgr);
void double_pendulum_2_836bb176_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  double *error);
void double_pendulum_2_836bb176_1_resetModeVector(const void *mech, int
  *modeVector);
boolean_T double_pendulum_2_836bb176_1_hasJointDisToNormModeChange(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector);
PmfMessageId double_pendulum_2_836bb176_1_performJointDisToNormModeChange(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *prevModeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
void double_pendulum_2_836bb176_1_onModeChangedCutJoints(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector,
  double *stateVector);
PmfMessageId double_pendulum_2_836bb176_1_assemble(const double *u, double *udot,
  double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  double_pendulum_2_836bb176_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  double_pendulum_2_836bb176_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  double_pendulum_2_836bb176_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mSimRuntimeDerivedValuesBundle);
  double_pendulum_2_836bb176_1_initializeGeometries
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  double_pendulum_2_836bb176_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = double_pendulum_2_836bb176_1_compDerivs(
      &smData->mSimRuntimeDerivedValuesBundle,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = double_pendulum_2_836bb176_1_numJacPerturbLoBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = double_pendulum_2_836bb176_1_numJacPerturbHiBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  errorId = double_pendulum_2_836bb176_1_compOutputs(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mM.mX,
    systemInput->mU.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = double_pendulum_2_836bb176_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 3,
    systemInput->mV.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    double_pendulum_2_836bb176_1_computeZeroCrossings(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double_pendulum_2_836bb176_1_constructStateVector(
    NULL,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 3,
    systemInput->mD.mX,
    fullStateVector);
  errorId = double_pendulum_2_836bb176_1_recordLog(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    fullStateVector,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL) {
    double result = 0.0;
    errorId = double_pendulum_2_836bb176_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = double_pendulum_2_836bb176_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 3,
      systemInput->mV.mX + 3,
  ...
  double_pendulum_2_836bb176_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const CTarget targets[4] = {
    { 0, 12, 0, false, 0, 2, "rad", false, true, +1.000000000000000000e+00,
    ...
    { 0, 13, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 13, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } }
  };
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = double_pendulum_2_836bb176_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = double_pendulum_2_836bb176_1_ZCData;
    size_t i;
  ...
  void initVariables(NeDaePrivateData *smData)
{
  const char *varFullPaths[4] = {
    "Subsystem.Revolute_Joint.Rz.q",
    "Subsystem.Revolute_Joint.Rz.w",
    "Subsystem.Revolute_Joint1.Rz.q",
    "Subsystem.Revolute_Joint1.Rz.w"
  };

  const char *varObjects[4] = {
    "double_pendulum_2/Subsystem/Revolute Joint",
    "double_pendulum_2/Subsystem/Revolute Joint",
    "double_pendulum_2/Subsystem/Revolute Joint1",
    "double_pendulum_2/Subsystem/Revolute Joint1"
  };
  ...
  void initIoInfo(NeDaePrivateData *smData)
{
  const char *inputPortPaths[3] = {
    "Subsystem.Revolute_Joint.ti",
    "Subsystem.Revolute_Joint1.ti",
    "Subsystem.External_Force_and_Torque.fx"
  };
  ...
  const char *outputPortPaths[4] = {
    "Subsystem.Revolute_Joint.q",
    "Subsystem.Revolute_Joint.w",
    "Subsystem.Revolute_Joint1.q",
    "Subsystem.Revolute_Joint1.w"
  };
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mSetTargets = double_pendulum_2_836bb176_1_setTargets;
  delegate->mResetStateVector = double_pendulum_2_836bb176_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    double_pendulum_2_836bb176_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState =
    double_pendulum_2_836bb176_1_computeDiscreteState;
  delegate->mAdjustPosition = double_pendulum_2_836bb176_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    double_pendulum_2_836bb176_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputePosDofBlendMatrix =
    double_pendulum_2_836bb176_1_computePosDofBlendMatrix;
  delegate->mComputeVelDofBlendMatrix =
    double_pendulum_2_836bb176_1_computeVelDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    double_pendulum_2_836bb176_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = double_pendulum_2_836bb176_1_propagateMotion;
  delegate->mComputeAssemblyError =
    double_pendulum_2_836bb176_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    double_pendulum_2_836bb176_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    double_pendulum_2_836bb176_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    double_pendulum_2_836bb176_1_isInKinematicSingularity;
  delegate->mConvertStateVector =
    double_pendulum_2_836bb176_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector = double_pendulum_2_836bb176_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    double_pendulum_2_836bb176_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    double_pendulum_2_836bb176_1_perturbFlexibleBodyState;
  ...
  delegate->mExtractSolverStateVector =
    double_pendulum_2_836bb176_1_extractSolverStateVector;
  delegate->mIsPositionViolation =
    double_pendulum_2_836bb176_1_isPositionViolation;
  delegate->mIsVelocityViolation =
    double_pendulum_2_836bb176_1_isVelocityViolation;
  delegate->mProjectStateSim = double_pendulum_2_836bb176_1_projectStateSim;
  delegate->mComputeConstraintError =
    double_pendulum_2_836bb176_1_computeConstraintError;
  delegate->mResetModeVector = double_pendulum_2_836bb176_1_resetModeVector;
  delegate->mHasJointDisToNormModeChange =
    double_pendulum_2_836bb176_1_hasJointDisToNormModeChange;
  delegate->mPerformJointDisToNormModeChange =
    double_pendulum_2_836bb176_1_performJointDisToNormModeChange;
  delegate->mOnModeChangedCutJoints =
    double_pendulum_2_836bb176_1_onModeChangedCutJoints;
  delegate->mMech = NULL;
}
