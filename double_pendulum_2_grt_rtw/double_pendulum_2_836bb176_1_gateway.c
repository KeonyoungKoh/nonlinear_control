...
#include "nesl_rtw.h"
#include "double_pendulum_2_836bb176_1.h"
#include "double_pendulum_2_836bb176_1_gateway.h"

void double_pendulum_2_836bb176_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0.001, 0.001, 0, 0,
    (NeModifyAbsTol) 0, 0.001, 0, 0, 0, 0, (SscLoggingSetting) 0, 572189389, 1,
  };
  ...
  double_pendulum_2_836bb176_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "double_pendulum_2/Subsystem/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
