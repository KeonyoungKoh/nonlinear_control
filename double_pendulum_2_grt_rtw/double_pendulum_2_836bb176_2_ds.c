 ...
 */
/* double_pendulum_2_836bb176_2_ds.c - body for module double_pendulum_2_836bb176_2_ds */

#include "ne_ds.h"
#include "double_pendulum_2_836bb176_2_ds.h"
#include "ssc_ml_fun.h"
#include "double_pendulum_2_836bb176_2_ds_external_struct.h"
#include "double_pendulum_2_836bb176_2_ds_externals.h"
#include "double_pendulum_2_836bb176_2_ds_sys_struct.h"
...
static NeEquationData s_equation_data[1] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "double_pendulum_2/Subsystem/Rotational Friction",
    1U, 0U, FALSE, 1.0, "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData *s_icr_data = NULL;
static NeVariableData s_variable_data[1] = { { "Subsystem.PS_Add.I1", 0U, 0,
    "double_pendulum_2/Subsystem/PS Add", 1.0, "1", 0.0, FALSE, FALSE, { { 1, 1
      } }, NE_INIT_MODE_NONE, "I1", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[17] = { {
    "Subsystem.Mechanical_Rotational_Reference.W.w",
    "double_pendulum_2/Subsystem/Mechanical Rotational Reference", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.PS_Add.I1", "double_pendulum_2/Subsystem/PS Add", { { 1, 1 } },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", }, { "Subsystem.PS_Add.I2",
    "double_pendulum_2/Subsystem/PS Add", { { 1, 1 } }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I2", }, { "Subsystem.PS_Add.O",
    "double_pendulum_2/Subsystem/PS Add", { { 1, 1 } }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, { "Subsystem.PS_Add_O",
    "double_pendulum_2/Subsystem/Revolute Joint", { { 1, 1 } }, "N*m", 1.0,
    "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "PS_Add_O", }, {
    "Subsystem.Revolute_Joint_w", "double_pendulum_2/Subsystem/Revolute Joint",
      { { 1, 1 } }, "rad/s", 1.0, "rad/s", NE_NOMINAL_SOURCE_FIXED,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Revolute_Joint_w", }, { "Subsystem.Rotational_Friction.C.w",
    "double_pendulum_2/Subsystem/Rotational Friction", { { 1, 1 } }, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Friction.R.w",
    "double_pendulum_2/Subsystem/Rotational Friction", { { 1, 1 } }, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Friction.t",
    "double_pendulum_2/Subsystem/Rotational Friction", { { 1, 1 } }, "N*m", 1.0,
    "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "Subsystem.Rotational_Friction.w",
    "double_pendulum_2/Subsystem/Rotational Friction", { { 1, 1 } }, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Friction.power_dissipated",
    "double_pendulum_2/Subsystem/Rotational Friction", { { 1, 1 } }, "J/s",
    1.0e-6, "J/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "Subsystem.Rotational_Multibody_Interface.C.w",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Multibody_Interface.R.w",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Multibody_Interface.t",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface", { { 1, 1 } },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "t", }, {
    "Subsystem.Rotational_Multibody_Interface.torque",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface", { { 1, 1 } },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Torque", }, {
    "Subsystem.Rotational_Multibody_Interface.w",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "w", }, {
    "Subsystem.Simulink_PS_Converter_output",
...
static NeAssertData s_assert_data[2] = { {
    "double_pendulum_2/Subsystem/Rotational Friction", 1U, 0U,
    "Subsystem.Rotational_Friction",
    ...
    "double_pendulum_2/Subsystem/Rotational Friction", 1U, 1U,
    "Subsystem.Rotational_Friction",
    "C:/Program Files/MATLAB/R2022a/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/friction.ssc",
    FALSE,
...
NeDynamicSystem *double_pendulum_2_836bb176_2_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  input_info[1].mIdentifier = "Subsystem.Revolute_Joint_w";
  ...
  input_info[1].mName = "Subsystem.Revolute_Joint_w";
  input_info[1].mUnit = "rad/s";
  ds->mIo[SSC_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[SSC_OUTPUT_IO_TYPE] = 1;
  output_info[0].mIdentifier = "Subsystem.PS_Add_O";
  ...
  output_info[0].mName = "Subsystem.PS_Add_O";
  ...
  *t2, NeDsMethodOutput *t3)
{
  ...
  X_idx_0 = t2->mX.mX[0];
  out = t3->mLOG;
  Subsystem_PS_Add_O = X_idx_0 + U_idx_0;
  out.mX[0] = X_idx_0;
  out.mX[1] = U_idx_0;
  out.mX[2] = Subsystem_PS_Add_O;
  out.mX[3] = Subsystem_PS_Add_O;
  out.mX[4] = U_idx_1;
  out.mX[5] = U_idx_1;
  out.mX[6] = -X_idx_0;
  out.mX[7] = U_idx_1;
