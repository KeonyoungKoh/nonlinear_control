...
const NeZCData *double_pendulum_2_836bb176_1_ZCData = NULL;
PmfMessageId double_pendulum_2_836bb176_1_computeAsmModeVector(const double
...
PmfMessageId double_pendulum_2_836bb176_1_computeSimModeVector(const double
  *input, const double *inputDot, const double *inputDdot, int *modeVector,
  double *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId double_pendulum_2_836bb176_1_computeZeroCrossings(const
