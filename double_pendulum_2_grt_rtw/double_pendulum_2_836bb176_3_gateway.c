...
#include "nesl_rtw.h"
#include "double_pendulum_2_836bb176_3.h"
#include "double_pendulum_2_836bb176_3_gateway.h"

void double_pendulum_2_836bb176_3_gateway(void)
{
  ...
  double_pendulum_2_836bb176_3_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "double_pendulum_2/Subsystem/Solver Configuration_3",
    1,
    &dae,
    &solverparams,
    &modelparams,
