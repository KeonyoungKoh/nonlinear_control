...
void double_pendulum_2_836bb176_1_perturbSimJointPrimitiveState(const void *mech,
...
void double_pendulum_2_836bb176_1_perturbFlexibleBodyState(const void *mech,
...
void double_pendulum_2_836bb176_1_constructStateVector(const void *mech, const
...
void double_pendulum_2_836bb176_1_extractSolverStateVector(const void *mech,
...
boolean_T double_pendulum_2_836bb176_1_isPositionViolation(const void *mech,
...
boolean_T double_pendulum_2_836bb176_1_isVelocityViolation(const void *mech,
  const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const
  double *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId double_pendulum_2_836bb176_1_projectStateSim(const void *mech,
...
void double_pendulum_2_836bb176_1_computeConstraintError(const void *mech, const
...
boolean_T double_pendulum_2_836bb176_1_hasJointDisToNormModeChange(const void
...
PmfMessageId double_pendulum_2_836bb176_1_performJointDisToNormModeChange(const
...
void double_pendulum_2_836bb176_1_onModeChangedCutJoints(const void *mech, const
