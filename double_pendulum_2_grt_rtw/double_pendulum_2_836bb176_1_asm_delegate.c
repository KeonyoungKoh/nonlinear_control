...
void double_pendulum_2_836bb176_1_setTargets(const RuntimeDerivedValuesBundle
...
void double_pendulum_2_836bb176_1_initializeTrackedAngleState(const void *mech,
...
void double_pendulum_2_836bb176_1_computeDiscreteState(const void *mech, const
...
void double_pendulum_2_836bb176_1_adjustPosition(const void *mech, const double *
...
void double_pendulum_2_836bb176_1_perturbAsmJointPrimitiveState(const void *mech,
...
void double_pendulum_2_836bb176_1_computePosDofBlendMatrix(const void *mech,
...
void double_pendulum_2_836bb176_1_computeVelDofBlendMatrix(const void *mech,
  size_t stageIdx, size_t primIdx, const double *state, int partialType, double *
  matrix)
{
  (void) mech;
...
void double_pendulum_2_836bb176_1_projectPartiallyTargetedPos(const void *mech,
...
void double_pendulum_2_836bb176_1_propagateMotion(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const double *state, double *motionData)
{
  ...
  xx[6] = 0.1715;
  xx[10] = xx[6] * xx[9];
  xx[11] = xx[5] - (xx[1] * xx[10] * xx[9] - xx[6]);
  xx[12] = xx[1] * xx[0] * xx[10];
  xx[10] = xx[12] * xx[4];
  xx[13] = xx[4] * xx[11];
  xx[14] = xx[5] * state[1];
  xx[5] = xx[11] * state[1] + xx[14];
  xx[15] = xx[5] * xx[9];
  xx[16] = xx[12] * state[1];
  xx[17] = xx[16] * xx[9];
  motionData[0] = - xx[2];
  ...
  motionData[18] = xx[11] - xx[1] * (xx[2] * xx[10] + xx[13] * xx[4]) - xx[7];
  motionData[19] = (xx[2] * xx[13] - xx[10] * xx[4]) * xx[1] + xx[12] + xx[8];
  motionData[20] = xx[3];
  motionData[21] = xx[3];
  motionData[22] = xx[3];
  ...
  motionData[30] = xx[1] * (xx[0] * xx[15] + xx[17] * xx[9]) - xx[16];
  motionData[31] = xx[5] - (xx[15] * xx[9] - xx[0] * xx[17]) * xx[1] + xx[6] *
    state[3];
  motionData[32] = xx[3];
}

size_t double_pendulum_2_836bb176_1_computeAssemblyError(const void *mech, const
...
size_t double_pendulum_2_836bb176_1_computeAssemblyJacobian(const void *mech,
...
size_t double_pendulum_2_836bb176_1_computeFullAssemblyJacobian(const void *mech,
...
boolean_T double_pendulum_2_836bb176_1_isInKinematicSingularity(const void *mech,
...
void double_pendulum_2_836bb176_1_convertStateVector(const void *asmMech, const
