 ...
 */
/* double_pendulum_2_836bb176_3_ds.c - body for module double_pendulum_2_836bb176_3_ds */

#include "ne_ds.h"
#include "double_pendulum_2_836bb176_3_ds.h"
#include "ssc_ml_fun.h"
#include "double_pendulum_2_836bb176_3_ds_external_struct.h"
#include "double_pendulum_2_836bb176_3_ds_externals.h"
#include "double_pendulum_2_836bb176_3_ds_sys_struct.h"
...
static void rtpmap(const NeDynamicSystem * ds, const PmIntVector* inl, const
                   ...
                   PmRealVector* outr);
static NeEquationData s_equation_data[1] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "double_pendulum_2/Subsystem/Rotational Friction1",
    1U, 0U, FALSE, 1.0, "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData *s_icr_data = NULL;
static NeVariableData s_variable_data[1] = { { "Subsystem.PS_Add1.I2", 0U, 0,
    "double_pendulum_2/Subsystem/PS Add1", 1.0, "1", 0.0, FALSE, FALSE, { { 1, 1
      } }, NE_INIT_MODE_NONE, "I2", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[17] = { {
    "Subsystem.Mechanical_Rotational_Reference1.W.w",
    "double_pendulum_2/Subsystem/Mechanical Rotational Reference1", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.PS_Add1.I1", "double_pendulum_2/Subsystem/PS Add1", { { 1, 1 } },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", }, { "Subsystem.PS_Add1.I2",
    "double_pendulum_2/Subsystem/PS Add1", { { 1, 1 } }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I2", }, { "Subsystem.PS_Add1.O",
    "double_pendulum_2/Subsystem/PS Add1", { { 1, 1 } }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, { "Subsystem.PS_Add1_O",
    "double_pendulum_2/Subsystem/Revolute Joint1", { { 1, 1 } }, "N*m", 1.0,
    "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "PS_Add1_O", }, {
    "Subsystem.Revolute_Joint1_w", "double_pendulum_2/Subsystem/Revolute Joint1",
    { { 1, 1 } }, "rad/s", 1.0, "rad/s", NE_NOMINAL_SOURCE_FIXED,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Revolute_Joint1_w", }, { "Subsystem.Rotational_Friction1.C.w",
    "double_pendulum_2/Subsystem/Rotational Friction1", { { 1, 1 } }, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Friction1.R.w",
    "double_pendulum_2/Subsystem/Rotational Friction1", { { 1, 1 } }, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Friction1.t",
    "double_pendulum_2/Subsystem/Rotational Friction1", { { 1, 1 } }, "N*m", 1.0,
    "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "Subsystem.Rotational_Friction1.w",
    "double_pendulum_2/Subsystem/Rotational Friction1", { { 1, 1 } }, "rad/s",
    1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Friction1.power_dissipated",
    "double_pendulum_2/Subsystem/Rotational Friction1", { { 1, 1 } }, "J/s",
    1.0e-6, "J/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "Subsystem.Rotational_Multibody_Interface1.C.w",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface1", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Multibody_Interface1.R.w",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface1", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Subsystem.Rotational_Multibody_Interface1.t",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface1", { { 1, 1 } },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "t", }, {
    "Subsystem.Rotational_Multibody_Interface1.torque",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface1", { { 1, 1 } },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Torque", }, {
    "Subsystem.Rotational_Multibody_Interface1.w",
    "double_pendulum_2/Subsystem/Rotational Multibody Interface1", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "w", }, {
    "Subsystem.Simulink_PS_Converter1_output",
    "double_pendulum_2/Subsystem/Simulink-PS\nConverter1", { { 1, 1 } }, "N*m",
...
static NeAssertData s_assert_data[2] = { {
    "double_pendulum_2/Subsystem/Rotational Friction1", 1U, 0U,
    "Subsystem.Rotational_Friction1",
    "C:/Program Files/MATLAB/R2022a/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/friction.ssc",
    FALSE,
    ...
    "double_pendulum_2/Subsystem/Rotational Friction1", 1U, 1U,
    "Subsystem.Rotational_Friction1",
    "C:/Program Files/MATLAB/R2022a/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/friction.ssc",
    FALSE,
...
static NeRange s_equation_range[1] = { {
    "C:/Program Files/MATLAB/R2022a/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/friction.ssc",
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mA.mN = 1;
  out->mA.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 1);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mF.mN = 1;
  out->mF.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 1);
  return out;
}
  ...
  allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mDXF_P.mNumCol = 1;
  out->mDXF_P.mNumRow = 1;
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mTDXF_P.mNumCol = 1;
  out->mTDXF_P.mNumRow = 1;
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mIC.mN = 1;
  out->mIC.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 1);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mLOG.mN = 14;
  out->mLOG.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 14);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mIMIN.mN = 1;
  out->mIMIN.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 1);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mIMAX.mN = 1;
  out->mIMAX.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 1);
  return out;
}
...
NeDynamicSystem *double_pendulum_2_836bb176_3_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  input_info[0].mIdentifier = "Subsystem.Simulink_PS_Converter1_output";
  ...
  input_info[0].mName = "Subsystem.Simulink_PS_Converter1_output";
  input_info[0].mUnit = "N*m";
  input_info[1].mIdentifier = "Subsystem.Revolute_Joint1_w";
  ...
  input_info[1].mName = "Subsystem.Revolute_Joint1_w";
  input_info[1].mUnit = "rad/s";
  ds->mIo[SSC_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[SSC_OUTPUT_IO_TYPE] = 1;
  output_info[0].mIdentifier = "Subsystem.PS_Add1_O";
  ...
  output_info[0].mName = "Subsystem.PS_Add1_O";
                     ...
                     NeDsMethodOutput *t2)
{
  ...
  U_idx_1 = t1->mU.mX[1];
  out = t2->mF;
  U_idx_1 = -(tanh(U_idx_1 / 0.0001) * 2.0);
  out.mX[0] = U_idx_1;
  (void)sys;
  (void)t2;
  return 0;
  ...
  *t2, NeDsMethodOutput *t3)
{
  ...
  U_idx_1 = t2->mU.mX[1];
  out = t3->mDUF;
  U_idx_1 = cosh(U_idx_1 / 0.0001) * cosh(U_idx_1 / 0.0001);
  out.mX[0] = -(10000.0 * (1.0 / (U_idx_1 == 0.0 ? 1.0E-16 : U_idx_1)) * 2.0);
  (void)sys;
  (void)t3;
  return 0;
}
  ...
  *t2, NeDsMethodOutput *t3)
{
  ...
  X_idx_0 = t2->mX.mX[0];
  out = t3->mLOG;
  Subsystem_PS_Add1_O = U_idx_0 + X_idx_0;
  out.mX[0] = U_idx_0;
  out.mX[1] = X_idx_0;
  out.mX[2] = Subsystem_PS_Add1_O;
  out.mX[3] = Subsystem_PS_Add1_O;
  out.mX[4] = U_idx_1;
  out.mX[5] = U_idx_1;
  out.mX[6] = -X_idx_0;
  out.mX[7] = U_idx_1;
  out.mX[8] = -(X_idx_0 * U_idx_1);
  out.mX[9] = U_idx_1;
  out.mX[10] = X_idx_0;
  out.mX[11] = X_idx_0;
  out.mX[12] = U_idx_1;
